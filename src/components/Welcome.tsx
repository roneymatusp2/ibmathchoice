          ...
          <div className="p-8">
              ...
              <div className="bg-school-navy/5 rounded-lg p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-school-navy/70">
                      Pure mathematics focus, ideal for future engineers/physicists
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-school-navy/5 rounded-lg p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-school-navy/70">
                      Applied focus with advanced modeling and statistics
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-school-red/5 border-l-4 border-school-red p-6 rounded-r-lg mb-8">
              <div className="flex">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-school-navy mb-2">
                    Important Note
                  </h3>
